...
<head>
    <title>Modernize an Admin Panel Category Bootstrap Responsive Web Template | 500 Error Page :: w3layouts</title>
    <!-- Meta Tags -->
                        ...
                        <div class="row">
                            ...
                            <div class="error-right col-xl-8">
                                ...
                                <p class="error-text text-dark m-0">You can go to
                                    <a href="index" role="button">home page</a> or search below
                                </p>
                            </div>
                        </div>
