        ...
        <div class="wrapper">
         ...
         <section class="grids-section bd-content">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Trabajadores Externos </h4>
                          <br>
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <th class="text-nowrap" scope="row">Trabajador externo 1</th>
                            ...
                            <tr>
                                    <th class="text-nowrap" scope="row">Trabajador externo 2</th>
                                    <td>trabajador@trabajador.cl</td>
                                    <td>BCI</td>
                                    <td></td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <section class="grids-section bd-content">
                                                    <!-- Grids Info -->
                                                    <div class="outer-w3-agile mt-3">
                                                        <h4 class="tittle-w3-agileits mb-4">Trabajador Externo
                                                            </h4>
                                                        <table class="table table-bordered table-striped">
                                                            <thead>
                                                                <tr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <section class="grids-section bd-content">
                                                        <!-- Grids Info -->
                                                        <div class="outer-w3-agile mt-3">
                                                            <h4 class="tittle-w3-agileits mb-4">Trabajador Externo</h4>
