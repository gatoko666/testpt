        ...
        <div class="wrapper">
         ...
         <section class="grids-section bd-content">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Generar equipo de trabajo </h4>
                          <br>
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <th class="text-nowrap" scope="row">NOC</th>
                            ...
                            <tr>
                                <th class="text-nowrap" scope="row">TT</th>
                                <td>
                                    Turno Tarde
                                </td>
                                <td>
                                                            ...
                                                            <div class="container">
                                                                    <form>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-5">
                                                                                      <input type="text" class="form-control" id="inputabreviatura" placeholder="Abreviatura">
                                                                                    </div>
                                                                                  </div>
                                                                                  ...
                                                                                  <div class="form-group row">
                                                                                        ...
                                                                                        <div class="col-sm-5">
                                                                                          <input type="text" class="form-control" id="inputhorainicio" placeholder="Hora inicio">
                                                                                        </div>
                                                                                      </div>
                                                                                      ...
                                                                                      <div class="form-group row">
                                                                                            ...
                                                                                            <div class="col-sm-5">
                                                                                              <input type="text" class="form-control" id="inputtermino" placeholder="Hora Termino">
                                                                                            </div>
                                                                                          </div>
